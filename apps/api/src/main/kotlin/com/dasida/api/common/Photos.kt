...
object Photos {
    ...
    /** 캠페인 시드 전용 보정 컷(API 전용, photos.ts 미러 아님) — 썸네일이 주제와 어긋나던 항목의 교체 이미지. 전부 다운로드 검증됨. */
    val craft = listOf(
        "photo-1562113530-57ba467cea38", // 버려진 나무 의자
        "photo-1547609434-b732edfee020", // 목공 수작업
        "photo-1544164560-adac3045edb2", // 전동 공구 목공
        "photo-1562548210-9107ddb7004a", // 커피 마블 수제 비누
        "photo-1546552768-9e3a94b38a59", // 수제 비누 진열
    ).map { u(it) }
